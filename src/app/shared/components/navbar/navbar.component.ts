...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  get esClienteSolo(): boolean {
    return this.logged && !this.esAdmin && !this.esVendedor;
  }

  get puedeVerMisPedidos(): boolean {
    return this.esClienteSolo;
  }
